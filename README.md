...
1. Добавьте в каталог `artifacts` целевой сервис ([`app-order.jar`](https://github.com/netology-code/aqa-homeworks/blob/master/web/app-order.jar) — см. раздел «Настройка CI»).
...
<details><summary>Развернуть Задача №1: заказ карты</summary>
...
<details><summary>Развернуть Задача №2: проверка валидации</summary>
...
* Runs server: `java -jar artifacts/app-order.jar`
